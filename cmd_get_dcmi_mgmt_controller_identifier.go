...
func (c *Client) GetDCMIMgmtControllerIdentifier(offset uint8) (response *GetDCMIMgmtControllerIdentifierResponse, err error) {
...
func (c *Client) GetDCMIMgmtControllerIdentifierFull() ([]byte, error) {
	id := make([]byte, 0)
	offset := uint8(0)
	for {
		resp, err := c.GetDCMIMgmtControllerIdentifier(offset)
		if err != nil {
