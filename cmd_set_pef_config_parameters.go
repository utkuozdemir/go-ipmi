...
func (c *Client) SetPEFConfigParameters(paramSelector PEFConfigParamSelector, parameter PEFConfigParameter) (response *SetPEFConfigParametersResponse, err error) {
	request := &SetPEFConfigParametersRequest{
		ParamSelector: paramSelector,
		ConfigData:    parameter.Pack(),
	}
