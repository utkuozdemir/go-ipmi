...
func (c *Client) GetDCMITemperatureReadings(request *GetDCMITemperatureReadingsRequest) (response *GetDCMITemperatureReadingsResponse, err error) {
...
func (c *Client) GetDCMITemperatureReadingsForEntities(entityIDs ...EntityID) ([]DCMITemperatureReading, error) {
	...
	for _, entityID := range entityIDs {
		...
		response, err := c.GetDCMITemperatureReadings(request)
		if err != nil {
